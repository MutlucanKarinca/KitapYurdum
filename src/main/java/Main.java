...
public class Main {
    ...
    public static void main(String[] args) {
      ...
      /*  Set<String> names = new HashSet<>();
        ...
        productService.save("Şeker Portakalı", new BigDecimal("90000000.20"),
        ...
        //Sipariş oluşturma
        List<String> productsName = Arrays.asList("Küçük Prens","Şeker Portakalı");
        //List<Product> productList = productService.getProductsByNames(productsName);

        customerService.getCustomerList().forEach(System.out::println);
        customerService.saveOrder("cem@gmail.com", productsName);

        OrderService orderService =  ServiceFactory.getOrderService();

        System.out.println(customerService.getOrderList("cem@gmail.com"));
